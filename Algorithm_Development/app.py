...
if selected_nav == "Home":
    ...
    with col1:
        ...
        st.markdown(f"<div class='avatar-container'><a class='avatar-link' href='{url_kailash}'>Kailash Chandran J</a><p>u192519.kailashchandran@gmail.com</p></div>", unsafe_allow_html=True)
