...
with st.container():
    ...
    st.write("Mentor: Prof. Dr. Deivamani M")
    st.write("Industry Expert: Mr. Muthumani M")
    ...
    if st.button("Simulate Video Query"):
        ...
        for i, row in filtered_videos_df.iterrows():
            with st.container():
                ...
                st.image(f"https://img.youtube.com/vi/{row['link'].split('=')[1]}/maxresdefault.jpg", use_column_width=True)
